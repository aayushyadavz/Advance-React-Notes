...
const withPriceLabel = (RestaurantCard) => { // Takes RestaurantCard component as input

    return (props) => { // New component returning
        const { resData } = props;
        ...
        return (
            <div>
                ...
                <RestaurantCard {...props} /> {/* Forward all the props needed to RestaurantCard */}
            </div>
        );
    };
}
